...
import com.bee.community.dao.BBSPostCommentMapper;
    ...
    public Boolean delPostComment(Long commentId, Long userId) {
        ...
        if (userId.equals(bbsPostComment.getCommentUserId()) || userId.equals(bbsPost.getPublishUserId())) {
            ...
            if (commentCount >= 0) {
                ...
                if(bbsPostMapper.updateByPrimaryKeySelective(bbsPost) <= 0){
                    return false;
                }
            }

            // 删除评论
            return bbsPostCommentMapper.deleteByPrimaryKey(commentId) > 0;
        }
